...
import { Clock, CheckCircle2, GlassWater, Timer } from 'lucide-react';
...
export default function Barra({ orders, tables, onUpdateOrderStatus }: BarraProps) {
  ...
  return (
    <div className="p-4 md:p-8 bg-slate-100 min-h-screen">
      <div className="flex items-center gap-3 mb-6 md:mb-8">
        <div className="p-2 md:p-3 bg-red-800 text-white rounded-lg">
          <GlassWater size={24} className="md:w-7 md:h-7" />
        </div>
        <h2 className="text-2xl md:text-3xl font-bold text-slate-800">Pantalla de Barra (KDS)</h2>
      </div>
